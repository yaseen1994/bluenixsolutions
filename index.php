                        ...
                        <div class="container">
                            <div class="banner__content">
                                ...
                                <h1 data-animation="slideInRight" data-duration="2s" data-delay=".5s"
                                    class="text-white">
                                    We Build Fast, High-Converting Websites That Drive Real Business Growth
                                </h1>
                                <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" class="mt-20">
                                    We design, develop, and optimize websites that generate leads, improve performance,
                                    and scale your business online.
                                </p>
                                <a data-animation="slideInRight" data-duration="2s" data-delay=".9s" href="<?php echo $base_url; ?>/about"
                                    class="btn-one mt-60">Get a Free Website Audit <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="<?php echo $base_url; ?>/service-details">Website Development</a></h4>
                            <p>Custom, fast, and SEO-optimized websites built to convert visitors into customers.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="service__item active">
                            ...
                            <h4><a href="<?php echo $base_url; ?>/service-details">SEO Optimization</a></h4>
                            <p>Improve rankings, traffic, and visibility with technical and on-page SEO strategies.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="<?php echo $base_url; ?>/service-details">Website Speed Optimization</a></h4>
                            <p>We fix slow websites and improve load times for better user experience and conversions.</p>
                        </div>
                    </div>
                </div>
            </div>
